...
// import styles
import { CheckoutPage, CheckoutLeft, CheckoutRight, CheckoutAd, CheckoutTitle, CheckoutProductsContainer } from './CheckoutStyles';
			...
			<CheckoutLeft>
				...
				<CheckoutProductsContainer>
					...
					{basket.map((item, index) => {
						return <CheckoutProduct key={index} item={item} dispatch={dispatch}></CheckoutProduct>;
					})}
